...
| `xp_collected`                 | Track how much XP you collect from XP orbs (counts the orb's full XP value, even if mending consumes some).                   | `minecraft:custom` → `rjs-better-stats:xp_collected`            |
